          ...
          <div className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <Link
                ...
                <span
                  className={`absolute -bottom-1 left-0 w-0 h-0.5 bg-indigo-400 transition-all duration-300 group-hover:w-full ${location.pathname === link.path ? "w-full" : ""}`}></span>
              </Link>
            ))}
            {user && user.role === "admin" ? (
              <Link
                ...
                Dashboard
                <span
                  className={`absolute -bottom-1 left-0 w-0 h-0.5 bg-indigo-400 transition-all duration-300 group-hover:w-full`}></span>
              </Link>
            ) : (
              " "
            )}
            ...
            <div className="flex flex-col gap-6 text-center">
              ...
              {!isAuthenticated ? (
                <div className="flex flex-col gap-4">
                  ...
                  <Link
                    to="/register"
                    className="bg-white text-black py-3 rounded-full font-bold">
                    Register
                  </Link>
                </div>
              ) : (
